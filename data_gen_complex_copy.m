...
plot_data.plot.raw.figure1 = struct('subplot_cols', 2,
                                      'subplot_rows', 2,
...
plot_data.plot.raw.figure2 = struct('subplot_rows', 2,
                                       'subplot', {struct('plots', {'time', 'raw_voltage'}),
                                                   struct('plots', {'time', 'current'},
                                                          'regression', 'Root')})

plot_data.plot.raw.figure3 = struct('subplot', {struct('plots', {'phi', 'time'},
                                                          'plot_type', 'Polar',
                                                          'title', 'example of polar plot')})
plot_data.plot.raw.figure4 = struct('subplot_cols', 2,
